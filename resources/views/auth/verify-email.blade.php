<x-guest-layout>
    <x-authentication-card>
        ...
        <div class="mb-4 text-sm text-gray-600">
            {{ __('قبل المتابعة، هل يمكنك التحقق من عنوان بريدك الإلكتروني من خلال النقر على الرابط الذي أرسلناه إليك للتو عبر البريد الإلكتروني؟ إذا لم تتلق البريد الإلكتروني، فسنرسل إليك بكل سرور بريدًا إلكترونيًا آخر.') }}
        </div>
