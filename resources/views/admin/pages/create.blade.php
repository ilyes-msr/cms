        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
              <div class="table-responsive">
                <form method="POST" action="{{route('pages.store')}}" class="my-5" novalidate>
                  @csrf
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <textarea name="content" id="page-content" rows="5" class="form-control @error('content') is-invalid @enderror">{{old('content')}}</textarea>
                    @error('content')
                      <div class="alert alert-danger mt-2">{{ $message }}</div>
                    @enderror
                  </div>

                  <button type="submit" class="btn btn-outline-primary add-button">انشاء</button>
                </form>
